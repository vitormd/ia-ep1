...
nmarqGoals = 'Data/goalsUmVsUm_QLearning5x3.mat'; %arquivo que salva as diffes dos gols e o timer49.988
nmarqAgente = 'Data/agenteUmVsUm_QLearning5x3.mat';%arquivo que salva o agente
...
function agente = CriaAgenteA(M)
    ...
    gamma = 0.99;
    alpha = 0.1;
    agente = QLearning(nA,epsilon,gamma,alpha,M); 
end
...
function action = EscolheAcaoA(nPlayer,agente,sOld,aOld,reward,sNew,notFirst,tempopartida)
    ...
    if notFirst
        agente.update(sOld,aOld,reward,sNew);
    end
end
